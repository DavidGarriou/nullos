...
gcc -m32 -I${SRCDIR} -c src/0/boot/grub/multiboot.S -o ${BUILDDIR}/boot.o -O2 -Wall -Wextra

gcc -m32 -I${SRCDIR} -c src/0/kernel/kernel.c -o ${BUILDDIR}/kernel.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
